...
3. **Schritt 2 „Abstimmen"**: ein Klick, hinter dem beides steckt. Erst der Rest von Phase A —
   ...
   lässt sich der Zwischenstand auszählen. Eine Anzeigeentscheidung, kein Schutz, und so gewollt
   (KODEX § 8, EIP-T-056).
...
`py-blind-rsa`, `rfc9474`: jeweils keine Distribution). Geprüft zugekauft sind SHA-384, die
